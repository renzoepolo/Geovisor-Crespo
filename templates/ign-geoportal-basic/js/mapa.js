...
//Change logotype
$('#top-left-logo-link').attr("href","https://www.crespo.gob.ar/");
$('#top-left-logo').attr("src","templates/ign-geoportal-basic/img/logo.png");
$('#top-left-logo').attr("alt","Logo Municipalidad de Crespo");
$('#top-left-logo').attr("title","Municipalidad de crespo");
		...
		ordered.forEach(function(e){
			switch (e) {
				...
				case 'Measure':
					...
					var measureControl = new L.Control.Measure({ position: 'topleft', primaryLengthUnit: 'meters', secondaryLengthUnit: 'kilometers', primaryAreaUnit: 'sqmeters', secondaryAreaUnit: 'hectares',decPoint: ',', thousandsSep: '.', activeColor:'#FFD73A', completedColor: '#FFD73A'});
	...
	switch(unordered) {
		case 'leaflet':
			...
			mapa = L.map('mapa', {
			    center: [-40, -59],
			    zoom: 4,
			    layers: [], /* se borró argenmap del array */
				zoomControl: false,
				minZoom: 3,
			    maxZoom: 21
			});
